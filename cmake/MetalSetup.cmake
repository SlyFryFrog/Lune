function(setup_metal_for_target target_name)
    if(APPLE)
        ...
        set(METAL_INCLUDE_DIRS "${METAL_CPP_DIR}")
        target_include_directories(${target_name} SYSTEM PRIVATE ${METAL_INCLUDE_DIRS})
        ...
        target_compile_definitions(${target_name} PRIVATE USE_METAL=1)
    else()
